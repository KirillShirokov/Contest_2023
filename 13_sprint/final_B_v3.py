...
def compare(compare_dt, pivot):
    points_compare_dt, fines_compare_dt, name_compare_dt = compare_dt
    points_pivot, fines_pivot, name_pivot = pivot
    return (-points_compare_dt, fines_compare_dt, name_compare_dt) < (-points_pivot, fines_pivot, name_pivot)
